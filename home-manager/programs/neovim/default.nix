      ...
      categoryDefinitions.replace = {
        ...
        startupPlugins = {
          general = with pkgs.vimPlugins; [
            ...
            lzextras
            onedark-nvim
            (mkPlugin "vague.nvim" (builtins.fetchGit {
      ...
      packageDefinitions.replace = {
        ...
        homeNvim = {
          ...
          extra = {
            ...
            nixdExtras.nixos_options = ''(builtins.getFlake "path:${builtins.toString inputs.self.outPath}").nixosConfigurations.nixbtw.options'';
            nixdExtras.home_manager_options = ''(builtins.getFlake "path:${builtins.toString inputs.self.outPath}").homeConfigurations.tomas@nixbtw.options'';
          };
        };
      };
    };
